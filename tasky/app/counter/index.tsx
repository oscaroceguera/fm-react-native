...
export default function CounterScreen() {
  ...
  const lastcompleteTimestamp = countdownState?.completedAtTimestamps[0];
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      const timestamp = lastcompleteTimestamp
        ? lastcompleteTimestamp + frequency
        : Date.now();

      if (lastcompleteTimestamp) {
        setIsLoading(false);
      }
